 ...
 */		// 初始化多个可选择搜索条件
		...
		$.each(resultJson2.rows ,function (i,obj) {
			// type为3是【自定义查询】
			if( obj.type != 3 ){
				queryShowTotal ++;
			}
	 ...
	 */
		// 自定义查询中元素初始化动态填充
		highSearch_loadCustomData(fieldList, resultJson2);
	// }
// });
...
// 加载高级搜索块的 自定义选项
function highSearch_loadCustomData(fieldList, resultJson2){
